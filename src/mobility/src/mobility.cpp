...
geometry_msgs::Pose2D iniLocation;
...
*/
    ...
    odomSub = mNH.subscribe((publishedName + "/odom"),1, odomHandler);
...
void odomHandler(const nav_msgs::Odometry::ConstPtr& message){
    iniLocation.x = message->pose.pose.position.x;
    iniLocation.y = message->pose.pose.position.y;
}
